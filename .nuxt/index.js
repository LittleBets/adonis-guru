...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_018c6234 === 'function') {
    await nuxt_plugin_plugin_018c6234(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_2bcdb762 === 'function') {
    await nuxt_plugin_pluginclient_2bcdb762(app.context, inject)
  }
