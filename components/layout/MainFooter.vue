<template>
  <footer class="bg-white mt-12">
    <div class="mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-6">
        ...
        >
          ...
          >
            ...
            >
              <g
                id="cleaver_logo"
                transform="translate(-184.000000, -214.000000)"
              >
                <g
                  id="logo_cleaver-copy"
                  transform="translate(184.000000, 214.000000)"
                >
                  <g
                    id="Group"
                    transform="translate(0.232002, 0.677165)"
                  >
                    <circle
                      id="Oval"
                      cx="356.201069"
          ...
          <span style="margin-left:5px; letter-spacing: 0.05em;">Powered by Cleavr</span>
        </a>
      </div>
